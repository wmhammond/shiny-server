...
```
## Slope
#### Slope of vulnerability curve (% / MPa) = (88-12)/(P88-P12) [(Domec and Gartner, 2001)](https://doi.org/10.1007/s004680100095){target="_blank"}
...
## P50 method
#### DH = dehydration, CE = centrifuge, CA = cavitron, AD = air-injection double end, AS = air-injection single end, AE = acoustic emissions, OV = optical vulnerability [(Brodribb *et al.*, 2017)](https://doi.org/10.1104/pp.17.00552){target="_blank"}, MicroCT = microCT, Pn = pneumatic method/Pneumatron, MRI (magnetic resonance imaging)
