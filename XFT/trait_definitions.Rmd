...
## P50 method
#### DH = dehydration, CE = centrifuge, CA = cavitron, AD = air-injection double end, AS = air-injection single end, AE = acoustic emissions, OV =  [Optical Vulnerability](https://doi.org/10.1104/pp.17.00552), MicroCT = microCT, Pn = pneumatic method/Pneumatron, MRI (magnetic resonance imaging)
