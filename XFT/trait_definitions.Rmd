...
```{r fig.align='center',p12, echo=FALSE, fig.cap="A vulnerability curve with P50 circled.", out.width = '100%'}
knitr::include_graphics("www/p12.png")
```

## P88
#### the xylem tension at which 88% of the maximum hydraulic conductivity is lost
```{r fig.align='center',p88, echo=FALSE, fig.cap="A vulnerability curve with P50 circled.", out.width = '100%'}
