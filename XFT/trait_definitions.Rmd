...
## Plant Organ
#### Organ of the plant in which the measurements were conducted. S= stem, T= trunk, R = root, P= petiole of leaf, L = whole leaf, LX = leaf xylem.
## Developmental Stage
#### Developmental stage as described by the data's reference paper. Se = seedling, Sa = sapling, A = adult
## Growthform
